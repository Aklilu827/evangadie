    ...
    <div className="container-fluid login_page">
      <div className="container py-5 d-md-flex justify-content-between login_container">
        ...
        <div className="sideNote2 container col-12 col-md-6 ms-md-2  mt-sm-5">
         ...
         <p> No matter what stage of life you are in, whether you're just starting elementary school or being promoted to CEO of a Fortune 500 copany, you have much to offer to who are trying to follow in your footseps.</p>   
