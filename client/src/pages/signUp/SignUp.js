    ...
    <div className="container-fluid sign_page">
      <div className="container d-md-flex mx-auto py-5 align-items-center">
        ...
        <div className="SignupNote container col-12 col-md-6 ms-md-2  mt-sm-5">
          ...
          <p className="lorem">No matter what stage of life you are in, whether you're just starting elementary school or being promoted to CEO of a Fortune 500 copany, you have much to offer to those who are trying to follow in your footseps.</p>   
          <p>Wheather you are willing to share your knowledge or you are just looking to meet menors of your own, please start by joining the network here.</p>
